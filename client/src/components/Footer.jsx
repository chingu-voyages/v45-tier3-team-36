...
const RoutesWithoutFooter = ["/login", "/sign-up", "/reset-password", "/forgot-password", "/signup-successful", "/sign-up/verify-email", "/forgot-password/initialize_password_reset"]
